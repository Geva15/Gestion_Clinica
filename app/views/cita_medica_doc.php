...
<body class="bg-gray-50 font-sans">
    ...
    <div class="container mx-auto p-5">
        ...
        <div class="bg-white p-5 rounded-lg shadow-md mb-5">
            ...
            <div class="mt-4">
                <button class="bg-purple-300 text-purple-900 font-bold py-2 px-4 rounded hover:bg-purple-400">Finalizar Cita</button>
        ...
        <form method="POST" action="../controllers/guardar_historial.php">
            ...
            <div class="mt-5">
                ...
                <div class="flex flex-wrap gap-2 mb-3">
                    ...
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="antecedentes_no_patologicos[]" value="Digestivos" class="mr-2"> Digestivos
                    </label>
                    <label class="inline-flex items-center">
            ...
            <div class="mt-5">
                ...
                <textarea name="recomendaciones" class="border border-gray-300 rounded p-2 w-full h-24" placeholder="Especifique las recomendaciones..."></textarea>
            </div>

            <div class="mt-5">
                <h3 class="text-lg font-bold text-Moradote">Observaciones</h3>
                <textarea name="observaciones" class="border border-gray-300 rounded p-2 w-full h-24" placeholder="Especifique observaciones adicionales..."></textarea>
            </div>
